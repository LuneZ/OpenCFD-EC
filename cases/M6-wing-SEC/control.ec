$control_ec
  Ma=0.8395d0
  Re=11.72d6
  AoA=3.06d0              ! Angle of Attack
  Iflag_init=0            ! Start from initial flow
  If_viscous=1
  Iflag_turbulence_model=2    ! SA   
  Kstep_save=5000
  t_end=500.d0     
  CFL=5.d0           
  Iflag_local_dt=1   !  1  Local time step, 0 Global time step
  ...
  Mesh_File_Format=1    ! 0 unformatted, 1 formatted
  Cood_Y_UP=1           ! Y-direction is Up
  NUM_THREADS=1         
 $end
!-------------------------------------------------------
 OpenCFD-EC ver 1.11 control file
!======C C C ============================================
